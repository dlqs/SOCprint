...
DESCRIPTION
  ...
  Besides the above, this script has zero-dependencies, is portable, and handles 
  text/byte streams. This makes printing in SoC a painless, non-ass-sucking experience 
  that doesn't require installing any drivers.
...
STANDARDS
  This script targets conformance to POSIX.1-2017 standards (https://pubs.opengroup.org/onlinepubs/9699919799/). Yes, you read that right and no, we're not kidding. POSIX™ compliance is 
  serious enterprise business!!!1 POSIX™ is a Trademark of The IEEE.
